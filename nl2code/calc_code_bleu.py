...
keywords = [x.strip() for x in open(os.path.join(pathlib.Path(__file__).parent.resolve(),'keywords/'+args.lang+'.txt'), 'r', encoding='utf-8').readlines()]
